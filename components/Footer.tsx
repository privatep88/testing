...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#091526] text-white w-full border-t-4 border-[#eab308] mt-auto">
      ...
      {/* Bottom Bar */}
      <div className="bg-[#060e1a] py-6 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center text-sm text-gray-500 gap-2">
          <p className="text-white opacity-80">اعداد وتصميم / خالد الجفري</p>
